...
const {
  ...
  setupDbCloseConditions: setupPostgresDbCloseConditions,
  createTables: createPostgresTables,
  serializeInmateAggregate: serializePostgresInmateAggregate,
  end: endPostgres,
} = require("../database/postgreSqlUtils");
const {
  getClient: getSqliteClient,
  createTables: createSqliteTables,
  serializeInmateAggregate: serializeSqliteInmateAggregate,
  setupDbCloseConditions: setupSqliteDbCloseConditions,
  end: endSqlite,
} = require("../database/sqliteUtils");
...
async function main() {
  ...
  const sqlite = getSqliteClient(":memory:");
  try {
